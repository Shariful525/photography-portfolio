    ...
    <footer class="bg-[#161515] text-white lg:py-10 pt-[105px] pb-[37px]  px-2 lg:px-52 max-w-[1440px] mx-auto relative">
      ...
      <div class="mt-8 grid md:grid-cols-4 grid-cols-2 gap-4 px-[35px] text-center">
        <div class="text-center md:text-left">
          <h3 class="lg:text-lg text-[16px] text-white  lg:font-semibold">Building design website</h3>
        </div>
        <div class="text-center md:text-left ">
          <h3 class="lg:text-lg text-[16px] text-white  lg:font-semibold">Business network</h3>
        </div>
        <div class="text-center md:text-left">
          <h3 class="lg:text-lg text-[16px] text-white lg:font-semibold">Gym app site</h3>
        </div>
        <div class="text-center md:text-left">
          <h3 class="lg:text-lg text-[16px] text-white  lg:font-semibold">Financial app website</h3>
        </div>
      </div>
      ...
      <div className="flex items-center gap-[20px] justify-center">
        ...
        <Link target="blank" to='www.expertsquad.net ' className="lg:w-[47px] lg:h-[45px] w-[30px]">
